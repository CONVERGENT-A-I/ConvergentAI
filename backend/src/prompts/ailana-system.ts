...
- VOICE MODALITY RULE: Never use visual framing in voice sessions. Use: "sound right" / "is this information correct" / "match what you know". Never use: "sound correct" / "do they sound correct" / "look right" / "see on your screen" / "as you can see". For contact details (name, email, phone), always ask: "is this information correct".
