      ...
      const results = await extractMultipleFields(text, lastQuestion, [
        {
          ...
          expectedType: 'string',
          additionalInstructions: 'Extract the email address mentioned. Fix STT formatting (replace "at" with "@", "dot" with ".", remove spaces). Example: "david at example.com" or "david at the rate example dot com" -> "david@example.com". Return string or null.',
        },
        {
          name: 'contact_mobile',
