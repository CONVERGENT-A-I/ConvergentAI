...
const tocItems = [
  ...
  { id: "section-5", label: "5. PURCHASES AND PAYMENT" },
  { id: "section-6", label: "6. SUBSCRIPTIONS" },
  { id: "section-7", label: "7. PROHIBITED ACTIVITIES" },
  { id: "section-8", label: "8. USER GENERATED CONTRIBUTIONS" },
  { id: "section-9", label: "9. CONTRIBUTION LICENSE" },
  { id: "section-10", label: "10. MOBILE APPLICATION LICENSE" },
  { id: "section-11", label: "11. SERVICES MANAGEMENT" },
  { id: "section-12", label: "12. PRIVACY POLICY" },
  { id: "section-13", label: "13. TERM AND TERMINATION" },
  { id: "section-14", label: "14. MODIFICATIONS AND INTERRUPTIONS" },
  { id: "section-15", label: "15. GOVERNING LAW" },
  { id: "section-16", label: "16. DISPUTE RESOLUTION" },
  { id: "section-17", label: "17. CORRECTIONS" },
  { id: "section-18", label: "18. DISCLAIMER" },
  { id: "section-19", label: "19. LIMITATIONS OF LIABILITY" },
  { id: "section-20", label: "20. INDEMNIFICATION" },
  { id: "section-21", label: "21. USER DATA" },
  { id: "section-22", label: "22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES" },
  { id: "section-23", label: "23. SMS TEXT MESSAGING" },
  { id: "section-24", label: "24. CALIFORNIA USERS AND RESIDENTS" },
  { id: "section-25", label: "25. MISCELLANEOUS" },
  { id: "section-26", label: "26. CONTACT US" },
];
    ...
    <div className="min-h-screen bg-bg-primary flex flex-col selection:bg-brand-teal/30 selection:text-white">
      ...
      <main className="flex-1 pt-60 pb-24 w-full">
        <div className="w-full max-w-4xl mx-auto px-5 sm:px-8 md:px-12">
          ...
          {/* Intro */}
          <h2 className="text-2xl font-bold tracking-wide mb-5 uppercase text-white border-b border-white/10 pb-2">Agreement to Our Legal Terms</h2>
          ...
          <ul className="space-y-2 mb-16 list-none pl-0">
            {tocItems.map((item) => (
              <li key={item.id}>
                <button
          ...
          <div className="space-y-14">
            ...
            <section id="section-1" className="scroll-mt-32">
              <h3 className={sectionHead}>1. OUR SERVICES</h3>
              <p className={`${prose} mb-4`}>
                The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.
              </p>
              <p className={prose}>
                The Services are intended to assist users with workflows that may be subject to various state and federal financial regulations. Users are solely responsible for ensuring that their use of the platform, including any data processing or communication generated through the platform, complies with all applicable United States banking, lending, and mortgage laws, rules, and regulatory statutes. This includes, but is not limited to, the Truth in Lending Act (TILA), the Real Estate Settlement Procedures Act (RESPA), the Secure and Fair Enforcement for Mortgage Licensing Act (SAFE Act), and all relevant regulations enforced by the Consumer Financial Protection Bureau (CFPB) and state banking regulators.
              </p>
            </section>

            {/* 2 */}
            <section id="section-2" className="scroll-mt-32">
              <h3 className={sectionHead}>2. INTELLECTUAL PROPERTY RIGHTS</h3>

              <h4 className={subHead}>Our intellectual property</h4>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-3" className="scroll-mt-32">
              <h3 className={sectionHead}>3. USER REPRESENTATIONS</h3>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-4" className="scroll-mt-32">
              <h3 className={sectionHead}>4. USER REGISTRATION</h3>
              <p className={prose}>
            ...
            <section id="section-5" className="scroll-mt-32">
              <h3 className={sectionHead}>5. PURCHASES AND PAYMENT</h3>
              <p className={`${prose} mb-4`}>
                We accept various forms of payment as indicated during the checkout process.
              </p>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-6" className="scroll-mt-32">
              <h3 className={sectionHead}>6. SUBSCRIPTIONS</h3>

              <h4 className={subHead}>Billing and Renewal</h4>
              <p className={`${prose} mb-4`}>
                Subscriptions do not automatically renew. Upon expiration, access to premium features will be paused, and users can manually renew their subscription at any time through their account billing dashboard.
              </p>

              <h4 className={subHead}>Free Trial</h4>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-7" className="scroll-mt-32">
              <h3 className={sectionHead}>7. PROHIBITED ACTIVITIES</h3>
              <p className={`${prose} mb-4`}>
              ...
              <ul className={bullet}>
                ...
                <li>Use any automated systems, bots, scrapers, or spiders to access, monitor, or copy any data or content from the platform without prior written authorization.</li>
                <li>Use the Services in a manner that disrupts, damages, or places an undue burden on our infrastructure, servers, or network bandwidth.</li>
                <li>Use the platform&apos;s outputs, data, or generated content to train, develop, or improve competing machine learning or artificial intelligence models.</li>
                <li>Reverse engineer, decompile, disassemble, or attempt to extract the source code, underlying algorithms, or models of the Services.</li>
            ...
            <section id="section-8" className="scroll-mt-32">
              <h3 className={sectionHead}>8. USER GENERATED CONTRIBUTIONS</h3>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-9" className="scroll-mt-32">
              <h3 className={sectionHead}>9. CONTRIBUTION LICENSE</h3>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-10" className="scroll-mt-32">
              <h3 className={sectionHead}>10. MOBILE APPLICATION LICENSE</h3>
              
              <h4 className={subHead}>Use License</h4>
              <p className={`${prose} mb-4`}>
              ...
              <h4 className={subHead}>Apple and Android Devices</h4>
              <p className={prose}>
            ...
            <section id="section-11" className="scroll-mt-32">
              <h3 className={sectionHead}>11. SERVICES MANAGEMENT</h3>
              <p className={prose}>
            ...
            <section id="section-13" className="scroll-mt-32">
              <h3 className={sectionHead}>13. TERM AND TERMINATION</h3>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-14" className="scroll-mt-32">
              <h3 className={sectionHead}>14. MODIFICATIONS AND INTERRUPTIONS</h3>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-15" className="scroll-mt-32">
              <h3 className={sectionHead}>15. GOVERNING LAW</h3>
              <p className={prose}>
            ...
            <section id="section-16" className="scroll-mt-32">
              <h3 className={sectionHead}>16. DISPUTE RESOLUTION</h3>
              <h4 className={subHead}>Informal Negotiations</h4>
              <p className={`${prose} mb-4`}>
              ...
              <h4 className={subHead}>Restrictions</h4>
              <p className={`${prose} mb-4`}>
                The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
              </p>
              
              <h4 className={subHead}>Exceptions to Informal Negotiations and Arbitration</h4>
              <p className={prose}>
            ...
            <section id="section-17" className="scroll-mt-32">
              <h3 className={sectionHead}>17. CORRECTIONS</h3>
              <p className={prose}>
            ...
            <section id="section-18" className="scroll-mt-32">
              <h3 className={sectionHead}>18. DISCLAIMER</h3>
              <p className={prose}>
            ...
            <section id="section-19" className="scroll-mt-32">
              <h3 className={sectionHead}>19. LIMITATIONS OF LIABILITY</h3>
              <p className={prose}>
            ...
            <section id="section-20" className="scroll-mt-32">
              <h3 className={sectionHead}>20. INDEMNIFICATION</h3>
              <p className={prose}>
            ...
            <section id="section-21" className="scroll-mt-32">
              <h3 className={sectionHead}>21. USER DATA</h3>
              <p className={prose}>
            ...
            <section id="section-22" className="scroll-mt-32">
              <h3 className={sectionHead}>22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
              <p className={prose}>
            ...
            <section id="section-23" className="scroll-mt-32">
              <h3 className={sectionHead}>23. SMS TEXT MESSAGING</h3>
              
              <h4 className={subHead}>Program Description</h4>
              <p className={`${prose} mb-4`}>
                By opting into any ConvergentAI Notifications text messaging program, you expressly consent to receive text messages (SMS) to your mobile number. ConvergentAI Notifications text messages may include: account alerts, responses to inquiries, order updates and special offers.
              </p>
              
              <h4 className={subHead}>Opting Out</h4>
              <p className={`${prose} mb-4`}>
              ...
              <h4 className={subHead}>Message and Data Rates</h4>
              <p className={`${prose} mb-4`}>
            ...
            <section id="section-24" className="scroll-mt-32">
              <h3 className={sectionHead}>24. CALIFORNIA USERS AND RESIDENTS</h3>
              <p className={prose}>
            ...
            <section id="section-25" className="scroll-mt-32">
              <h3 className={sectionHead}>25. MISCELLANEOUS</h3>
              <p className={prose}>
            ...
            <section id="section-26" className="scroll-mt-32">
              <h3 className={sectionHead}>26. CONTACT US</h3>
              <p className={`${prose} mb-4`}>
                In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
              </p>
              <div className="font-bold text-white leading-tight space-y-1 mt-2">
                <p>ConvergentAI, Inc.</p>
                <p>2209 Chamberlain Ave., Unit B</p>
