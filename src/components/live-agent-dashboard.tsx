          ...
          <div className="flex flex-col justify-center">
            ...
            {/* <motion.div variants={itemVariants}>
              <a
                ...
                className="group relative inline-block bg-brand-green text-white px-4 md:px-6 py-3 md:py-4 rounded-2xl text-xs md:text-sm font-black uppercase tracking-wide hover:shadow-[0_0_40px_rgba(0,26,91,0.5)] transition-all transform hover:-translate-y-1 active:scale-95"
              >
