      ...
      {isMinimized ? (
        ...
        >
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-[#0b0f19]/95 border border-[#00b4d8]/50 rounded-full shadow-[0_0_25px_rgba(0,180,216,0.4)] text-white text-xs font-semibold hover:bg-[#131b2e] hover:border-[#00b4d8] transition duration-200 backdrop-blur-xl cursor-pointer"
          >
            ...
            <Maximize2 className="w-3.5 h-3.5 text-gray-400 ml-1 hover:text-white" />
          </button>
        </motion.div>
      ) : (
        <motion.div
