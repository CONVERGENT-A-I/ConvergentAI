    ...
    <section id="features-hero" className="relative min-h-[70svh] flex items-center justify-center pt-44 md:pt-52 pb-20 px-8 md:px-12 lg:px-24 overflow-hidden">
      ...
      >
        ...
        <motion.h1 variants={itemVariants} className="text-fluid-h1 font-black text-white mb-10 tracking-tight leading-[1.05]">
          AI Speed with <br className="hidden md:block" />
          <span className="text-brand-teal">Human Expertise</span>
        </motion.h1>

        {/* Subheadline / Description */}
        <motion.div variants={itemVariants} className="max-w-3xl space-y-8">
          <p className="text-fluid-p text-text-secondary font-medium balance">
            ConvergentAI helps financial institutions respond instantly, guide customers consistently, and connect high-intent conversations to the right human expert across digital, branch, and contact center experiences.
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 pt-8 opacity-60">
            ...
            <p className="text-xs md:text-sm font-bold tracking-widest text-text-muted uppercase">
              Responsive Engagement Across High-Value Customer Journeys
            </p>
            <div className="h-px w-12 bg-white/20 hidden md:block" />
          </div>
        </motion.div>
