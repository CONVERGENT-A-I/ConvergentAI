  ...
  return (
    <section id="leadership" className="bg-black py-20 md:py-32 px-6 sm:px-12 lg:px-24 border-t border-white/5 overflow-hidden">
      ...
      >
        ...
        {/* Team Grid - Circular Style - Flex wrap for natural balancing */}
        <div className="flex flex-wrap justify-center gap-y-16 md:gap-y-24 gap-x-8 md:gap-x-12 lg:gap-x-16 xl:gap-x-24 w-full items-start">
