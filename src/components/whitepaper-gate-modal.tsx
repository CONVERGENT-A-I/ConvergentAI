              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <a
                    ...
                    className="mt-4 inline-flex items-center gap-2.5 bg-brand-green text-black px-6 py-3 rounded-full text-sm font-black uppercase tracking-widest hover:shadow-[0_0_30px_rgba(0,255,153,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
                  >
                ...
                <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full mt-2 inline-flex items-center justify-center gap-2.5 bg-brand-green text-black px-7 py-3.5 rounded-full text-sm font-black uppercase tracking-widest hover:shadow-[0_0_30px_rgba(0,255,153,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-60 disabled:pointer-events-none"
                    >
                      {status === "submitting" ? (
                        <>
